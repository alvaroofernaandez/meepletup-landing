...
const Hero = () => {
  return (
    <div className="h-screen w-screen flex items-center justify-center text-center relative overflow-hidden">
      ...
      />
      <motion.div
        className="absolute bg-[#1f82b1] rounded-full opacity-20 blur-3xl"
      ...
      <div className="max-w-[90%] md:max-w-[70%] grid gap-8 z-10">
        ...
        <motion.h3
          className="font-extralight text-[#a8d8f0] text-lg md:text-xl lg:text-2xl"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <a href="https://play.google.com/store/apps/details?id=com.jmnzbrv.meepletup.prod" className="relative inline-flex h-12 active:scale-95 transistion overflow-hidden rounded-full p-[1px] focus:outline-none">
            ...
            <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-[#1f82b1] hover:bg-[#226d90] transition-all duration-300 px-7 text-sm font-semibold text-white backdrop-blur-3xl gap-2">
